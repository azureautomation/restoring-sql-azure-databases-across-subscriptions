...
workflow Restore-AzureDB
{
    ...
    (   
        ...
        [String]
        $AzureConnectionName = 'ayushk-lp.fareast.corp.microsoft.com',
    
        [Parameter(Mandatory=$true)]
        [String]
        $sourceServerName = 'wb2606ck4p',
     
        [Parameter(Mandatory=$true)]
        [String]
        $sourceDatabaseName = 'trialif2',
     
        [Parameter(Mandatory=$true)]
        [String]
        $targetdatabaseName = 'trialif2_test',
        ...
        [Parameter(Mandatory=$true)]
        [String]
        $targetServerLocation = 'East US',
     
        [Parameter(Mandatory=$true)]
        [String]
        $targetSubscriptionID = '3f1d7d2a-5058-4307-ae62-be0859e5c6f7'
    )
